...
function App() {
  ...
  useEffect(() => {
    const countDownDate = new Date("Nov 17, 2019").getTime();
          ...
          <div className="media-container-row align-center mbr-white">
            <div className="row row-copirayt">
              <p className="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">
                © Copyright 2019 Amrit Singh - All Rights Reserved
                    <br />
                Made with lots of <span className="fa fa-heart pulse2"></span> for Mandeep
                </p>
            </div>
          </div>
        </div>
